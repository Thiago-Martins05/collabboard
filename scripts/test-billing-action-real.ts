...
async function testBillingActionReal() {
  console.log("🧪 Testando billing action (versão real)...\n");
  ...
  try {
    ...
    try {
      ...
      console.error("❌ Erro no membership:", error);
      return;
    }
...
testBillingActionReal().catch(console.error);
